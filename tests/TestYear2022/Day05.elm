    ...
    test "Verify that we can parse the crate moving instructions." <|
        \_ ->
            let
                ...
                move_instruction = MoveInstruction 1 1 2
            in
            instruction
...
test_applyInstruction =
    test "Verify instructions are applied properly to stacks." <|
        \_ ->
            let
                input_stacks = [["D", "N", "Z"], ["C", "M"], ["P"]]
                move_instruction = createMoveInstruction 3 1 3
                output_stacks = [[], ["C", "M"], ["Z", "N", "D", "P"]]
            in
